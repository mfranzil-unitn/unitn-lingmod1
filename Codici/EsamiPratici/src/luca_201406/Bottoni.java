...
public class Bottoni extends HBox {
            ...
            public void handle(ActionEvent event) {
                ...
                for(int i = 0; i < dimensione;i++){
                    for(int j = 0; j < dimensione;j++){
                        if(celle[i][j].c.isVisible() == true) output.setText(output.getText()+" 1 ");
    ...
    public void cancella(int dimensione, Cella celle[][]){
        for(int i = 0; i < dimensione;i++){
            for(int j = 0; j < dimensione;j++){
                if(celle[i][j].c.isVisible() == true) celle[i][j].c.setVisible(false);
            }
        }
    }
    ...
    public void movimento(Cella celle[][], int dimensione,int alg){
                ...
                for(int i = 0; i < dimensione;i++){
                    for(int j = 0; j < dimensione;j++){
                        if(celle[i][j].c.isVisible() == true) save[i][j]=1;
                            else save [i][j]=0;
                    }
                }       
                cancella(dimensione,celle);
